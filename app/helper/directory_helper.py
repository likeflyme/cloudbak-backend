...
def get_session_dir(sys_session: SysSession) -> str:
    return os.path.join(get_session_base_dir(), sys_session.name)


def get_wx_dir(sys_session: SysSession) -> str:
    return os.path.join(get_session_dir(sys_session), sys_session.wx_id)
...
def get_head_session_dir(sys_session: SysSession):
    return os.path.join(get_head_base_dir(), sys_session.name)
